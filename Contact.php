                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="95%"><p class="style1"><strong>Head Police Station</strong></p>
                                <p class="style1"><strong>North West Road</strong></p>
                                <p class="style1"><strong>Alausa, Ikeja</strong></p></td>
                        </tr>
                        <tr>
                            <td><img src="images/call.png" width="32" height="32" /></td>
                            <td><p class="style1"><strong>+234 9012345678</strong></p>
                                <p class="style2">+234 8098765432</p></td>
                        </tr>
                        <tr>
                            <td><img src="images/mail.png" width="32" height="32" /></td>
                            <td><span class="style1"><strong>info@saynotocrime.com</strong></span></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
